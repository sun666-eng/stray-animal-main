...
Assert-True ($adminAdoptHtml -match 'admin-workspace\.css\?v=20260808c' -and $adminWorkspaceCss -match '\.admin-agent-draft-boundary' -and $adminWorkspaceCss -match 'admin-agent-draft-verdict') "admin adopt 3B: cache-busted stylesheet contains the human-confirmation layout"
