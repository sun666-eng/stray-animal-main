...
(async () => {
  ...
  try {
    ...
    assert('cache-u2-favorites', favHtml.includes('v=20260809u2'), 'fav-cache');
    assert('cache-u2-petcare', careHtml.includes('v=20260809u2'), 'care-cache');
    assert('shell-cache-favorites', favHtml.includes('front-shell.js?v=20260809u2'), 'shell-f');
    assert('shell-cache-petcare', careHtml.includes('front-shell.js?v=20260809u2'), 'shell-c');
    assert('workspace-cache-favorites', favHtml.includes('user-workspace.js?v=20260809u2'), 'ws-f');
    assert('workspace-cache-petcare', careHtml.includes('user-workspace.js?v=20260809u2'), 'ws-c');
