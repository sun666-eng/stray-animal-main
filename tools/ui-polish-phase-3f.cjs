...
(async () => {
  ...
  try {
    ...
    assert('cache-31f-favorites', favHtml.includes('v=20260731f'), 'fav-cache');
    assert('cache-31f-petcare', careHtml.includes('v=20260731f'), 'care-cache');
    assert('shell-cache-favorites', favHtml.includes('front-shell.js?v=20260731a'), 'shell-f');
    assert('shell-cache-petcare', careHtml.includes('front-shell.js?v=20260731a'), 'shell-c');
    assert('workspace-cache-favorites', favHtml.includes('user-workspace.js?v=20260731a'), 'ws-f');
    assert('workspace-cache-petcare', careHtml.includes('user-workspace.js?v=20260731a'), 'ws-c');
