...
(async () => {
  ...
  try {
    ...
    assert('user-cache-0808h', userHtml.includes('admin-workspace.css?v=20260809p'), 'cache');
    ...
    assert('person-cache-30j', personHtml.includes('admin-workspace.css?v=20260809p'), 'cache');
    assert('visit-untouched-cache', visitHtml.includes('20260809p'), 'visit');
    assert('vol-untouched-cache', volunteerHtml.includes('20260809p'), 'vol');
    ...
    assert('user-css-0808h', cssReq.some((u) => /v=20260809p/.test(u)), JSON.stringify(cssReq.slice(-2)));
