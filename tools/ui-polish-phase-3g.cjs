...
(async () => {
  ...
  try {
    ...
    assert('cache-login', loginHtml.includes('v=20260809u2'), 'login css');
    assert('cache-register', regHtml.includes('v=20260809u2'), 'reg css');
    assert('cache-workspace', loginHtml.includes('user-workspace.js?v=20260809u2') && regHtml.includes('user-workspace.js?v=20260809u2'), 'ws');
