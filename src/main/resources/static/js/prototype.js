(function () {
    ...
    function adminShell(active, content) {
        var menu = [['admin-dashboard', '▦', '运营总览'], ['admin-animals', '♢', '动物管理'], ['admin-adoptions', '♡', '领养审核'], ['admin-proofs', '▣', '凭证审核'], ['admin-visits', '⌁', '回访管理'], ['admin-volunteers', '♧', '志愿者审核'], ['admin-rescues', '!', '救助管理'], ['admin-notices', '◫', '公告管理'], ['admin-funds', '¥', '资金管理'], ['admin-users', '●', '用户管理'], ['admin-roles', '◇', '角色管理'], ['admin-permissions', '⌾', '权限管理']];
